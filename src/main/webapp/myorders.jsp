...
<form action="${pageContext.request.contextPath}/queryOrderByPage3"  method="post">
    <div class="layui-inline layui-show-xs-block"  style="margin-left: 10px;">

        <input type="text" id="orderNumber"  name="orderNumber"   placeholder="订单号" autocomplete="on" class="layui-input">
    </div>
...
<script>
    function  jiedan(id) {
        ...
        $.ajax({
            ...
            success:function () {
                window.location.href="/queryOrderByShopId2?shopId="+shopid;
            }
        })
    }
